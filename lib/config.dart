...
Email: When user asks about their emails, use the Gmail search tool to find relevant emails. Don't invent answers just reply with returned email snippets.
